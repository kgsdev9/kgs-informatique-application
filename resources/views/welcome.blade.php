...
<section class="py-4 bg-white dark:bg-gray-900 lg:pt-12 lg:pb-16">
    <div class="px-4 mx-auto max-w-8xl lg:px-4 lg:text-center">
        <a class="inline-flex items-center justify-between px-1 py-1 pr-4 mb-5 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200" role="alert" href="#">
            <span class="text-xs bg-blue-700 dark:bg-blue-600 rounded-full text-white px-4 py-1.5 mr-3">Kgs</span>
            <span class="mr-2 text-sm font-medium">Bienvenue sur kgs informatique</span>
            <svg class="w-2.5 h-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"></path>
            </svg>
        </a>
        <h5 class="mb-4 text-4xl font-bold tracking-tight text-gray-900 lg:font-extrabold lg:text-6xl lg:leading-none dark:text-white lg:text-center xl:px-36 lg:mb-7">Développeur web , Administrateur de base dé données , Support Informatique</h5>
        <p class="mb-10 text-lg font-normal text-gray-500 dark:text-gray-400 lg:text-center lg:text-xl xl:px-120">
           Développeur web experimenté avec plus de 50 certifiats profesionnels en informatque, et dans le domaine du devOpps j'ai de sacrés acquis dans le developpement et j'aimerais vous faire partager toutes ces connaissances téchniques avec une approche asymetrique
        </p>
        <div class="flex flex-col mb-8 md:flex-row lg:justify-center">
            <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-base px-6 py-2.5 text-center md:mr-5 mb-3 md:mb-0 inline-flex items-center justify-center">les articles </a>
            <a href="#components" class="text-gray-600 bg-white-100 hover:bg-gray-100 hover:text-blue-600 border border-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:border-gray-700 font-medium rounded-lg text-base px-6 py-2.5 text-center inline-flex justify-center items-center">
                ...
                <span class="ml-2">Démarrer maintenant </span>
            </a>
        </div>
...
<section class="pt-6 pb-8 bg-white lg:pb-24 dark:bg-gray-900">
	<div class="px-4 mx-auto text-center max-w-8xl lg:px-36">
		<span class="text-sm font-semibold text-gray-500">Les téchnologies à la une </span>
		<div class="flex flex-wrap justify-center items-center mt-8 lg:justify-between">
			<a class="mr-6 mb-5 text-gray-500 hover:text-gray-900 dark:hover:text-gray-300 lg:mb-0" href="#" rel="nofollow noreferrer noopener">
				<svg class="h-10" viewBox="0 32 447.99999999999994 448">
...
<section class="bg-gray-50 dark:bg-gray-800 border-t border-b border-gray-100 dark:border-gray-700">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
        <h2 class="mb-6 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 lg:text-center dark:text-white md:text-4xl">Les téchnologies que nous abordéront</h2>
        ...
        <div class="space-y-4 sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-4 xl:gap-8 sm:space-y-0 md:mt-12">
            ...
            <a href="#" class="block px-8 py-12 text-center bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600 hover:shadow-lg dark:hover:shadow-lg-light">
                <svg class="w-12 h-12 mx-auto text-blue-500" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
