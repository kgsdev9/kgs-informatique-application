...
<section class="py-4 bg-white dark:bg-gray-900 lg:pt-12 lg:pb-16">
	<div class="px-4 mx-auto max-w-8xl lg:px-4 lg:text-center">
		...
		<div class="flex flex-col mb-8 md:flex-row lg:justify-center">
			<a href="{{route('articles.index')}}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Nos Articles </a>
			<a href="{{route('login')}}" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
	...
	<div class="mx-auto w-full max-w-8xl px-4 py-8 lg:py-24">
		<div class="grid items-center grid-cols-1 gap-6 lg:grid-cols-2 xl:gap-32">
			<div class="mb-5 lg:mb-0">
				<h2 class="text-3xl font-bold leading-tight text-gray-900 dark:text-white lg:text-4xl mb-4">Comment KGS INFORMATIQUE   contribuent au développement des technologies  </h2>
				<p class="text-lg text-gray-500 dark:text-gray-400 mb-4 md:mb-6">
					Fondé dans l'optique d'aider, et de promouvoir  l'entraide entre informaticien
				</p>
				...
				<div class="items-center lg:flex">
					<a class="block w-full sm:w-auto sm:inline-block mb-3 sm:mb-0 text-white bg-blue-700 dark:bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-base px-5 py-2.5 text-center inline-block mr-4" href="{{route('articles.index')}}">Articles</a>
				...
				<div class="grid sm:grid-cols-2 gap-6">
                    ...
                    <a class="rounded-lg border border-gray-300 bg-white px-4 py-3.5 text-base font-medium text-gray-500 placeholder:py-3.5 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-400 dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700 sm:gap-6" href="{{route('article.show', $article->id)}}">
						<div class="flex items-center justify-between mb-4">
							...
							<span class="bg-gray-100 text-gray-500 text-xs font-semibold mr-2 px-2 py-0.5 rounded dark:bg-gray-700 dark:text-gray-400 hidden sm:flex">
                        ...
                        {{Str::limit( $article->mini_description, 56)}}
					</a>
